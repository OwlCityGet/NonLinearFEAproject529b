...
# Run by satri on Mon May 08 10:22:31 2017
#
...
openMdb(pathName='c:/SIMULIA/newT1p3Modelcontinue.cae')
#: The model database "c:\SIMULIA\newT1p3Modelcontinue.cae" has been opened.
...
session.viewports['Viewport: 1'].odbDisplay.display.setValues(plotState=(
    DEFORMED, ))
mdb.save()
#: The model database has been saved to "c:\SIMULIA\newT1p3Modelcontinue.cae".
