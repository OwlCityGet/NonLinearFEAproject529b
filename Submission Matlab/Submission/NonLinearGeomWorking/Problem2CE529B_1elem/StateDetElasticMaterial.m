...
% Mtijel : 3x3 Matrix stress for the gauss point analyzed
    ...
    gama=[gama33(1,1) gama33(2,2) gama33(3,3) 2*gama33(1,2) 2*gama33(2,3) 2*gama33(1,3)]';
    
    tijel=Et*gama;
    
    Mtijel=[tijel(1,1) tijel(4,1) tijel(6,1);
            tijel(4,1) tijel(2,1) tijel(5,1);
            tijel(6,1) tijel(5,1)  tijel(3,1)];
