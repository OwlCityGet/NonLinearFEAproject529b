...
%     if(abs(coord(i,1))>1.9*10^-2&&abs(coord(i,2)-1)>0.99*10^-2&&abs(coord(i,3)-1)>0.99*10^-2)
%         ind(i)=-0.75*1/12;
%     else
%         if(abs(coord(i,1))>1.9*10^-2&&(abs(coord(i,2)-1)<0.01*10^-2||abs(coord(i,3)-1)<0.01*10^-2))
%             ind(i)=0.75*1/3;
%         end
%     end
% end
...
ifordir_x=1*ones(1,size(ifornod,2));

ifordir=[ ifordir_z ifordir_x];
forval=[ -ind(ifornod)./40 ind(ifornod)] ;
ifornod=[ifornod ifornod];


% 
% ifornod = [6 12 5 18 1 13 2 17 6 ...
%            12 5 18 1 13 2 17];
% ifordir = [3*ones(1,size(ifornod,2))...
%             1*ones(1,size(ifornod,2))];
% Pz=1;
% Px=1;
% % forval = [Pz/12 -Pz/3 Pz/12 -Pz/3 Pz/12 -Pz/3 Pz/12 -Pz/3 ...
% %          -Px/12 Px/3 -Px/12 Px/3 -Px/12 Px/3 -Px/12 Px/3];
%      
%      forval = [Pz/12 -Pz/3 Pz/12 -Pz/3 Pz/12 -Pz/3 Pz/12 -Pz/3 ...
%          -Px/480 Px/120 -Px/480 Px/120 -Px/480 Px/120 -Px/480 Px/120];
