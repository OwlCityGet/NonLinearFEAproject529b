...
% LoadHist(2,1)=16.0*10^5 ;
% LoadHist(3,1)=32.0*10^5 ;
% LoadHist(4,1)=48.0*10^5 ;
% LoadHist(5,1)=-5.0*10^5 ;
% LoadHist(6,1)=-32.0*10^5;
% LoadHist(7,1)=-40.0*10^5 ;
% LoadHist(8,1)=-44.0*10^5;
% LoadHist(9,1)=16.0*10^5;
% LoadHist(10,1)=32.0*10^5;
